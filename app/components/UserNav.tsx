          ...
          {session ? (
            <div className="space-y-1">
              ...
              {isAdmin && (
                <Link
                  href="/admin/cars"
                  className="flex items-center gap-2 rounded-lg px-4 py-2.5 text-sm font-bold text-blue-600 transition hover:bg-blue-50"
              ...
              <button
                onClick={() => signOut()}
                className="flex w-full items-center gap-2 rounded-lg px-4 py-2.5 text-sm font-semibold text-red-600 transition hover:bg-red-50"
              >
            ...
            <div className="space-y-1">
              <Link
                href="/login"
                className="block rounded-lg px-4 py-2.5 text-sm font-bold text-gray-700 transition hover:bg-red-50 hover:text-red-600"
                onClick={() => setIsDropdownOpen(false)}
              >
                Đăng nhập
              </Link>
